...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.logto.management_app_id' => 'string',
            'services.logto.management_app_secret' => 'string',
            'services.logto.webhook_secret' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./app/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.logto.endpoint',
'services.logto.app_id','services.logto.app_secret','services.logto.redirect_uri','services.logto.management_api_resource','services.logto.management_api_identifier',
'services.logto.management_app_id','services.logto.management_app_secret','services.logto.webhook_secret','session.driver','session.lifetime',
...
'signed','throttle','verified','role','verify.logto.webhook',);
        registerArgumentsSet('routes', 'home','auth.login','auth.callback','auth.logout',
'webhooks.logto','dashboard','profile.show','profile.password.change','users.index',
'users.create','users.store','users.show','users.edit','users.update',
'users.destroy','users.reset-password.form','users.reset-password','storage.local','storage.local.upload',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','LOGTO_ENDPOINT','LOGTO_APP_ID',
'LOGTO_APP_SECRET','LOGTO_REDIRECT_URI','LOGTO_MANAGEMENT_API_RESOURCE','LOGTO_MANAGEMENT_API_IDENTIFIER','LOGTO_MANAGEMENT_APP_ID',
'LOGTO_MANAGEMENT_APP_SECRET','LOGTO_WEBHOOK_SECRET','LOGTO_WEBHOOK_URL',);
